	...
	<div class="flex-wrap lg:mx-14">
		...
		<div class="flex flex-col gap-2 lg:flex-row h-[60%]">
			...
			<div class="card flex flex-col gap-2">
				...
				<div class="flex flex-wrap items-center gap-2 mt-4 justify-between">
				...
				<div class="mt-3">
					<div x-data="{ switchOn: false }" class="flex items-center space-x-2">
						...
						<button x-ref="switchButton" type="button" @click="switchOn = ! switchOn" :class="switchOn ? 'bg-blue-600' : 'bg-neutral-200'" class="relative inline-flex h-6 py-0.5 ml-4 focus:outline-none rounded-full w-10" x-cloak>
